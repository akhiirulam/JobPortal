  ...
  const sideBarItems = [
    {
      ...
      link: "/employer/empDashBoard",
    },
    { id: 2, icon: faUserTie, description: "Profile", link: "/employer/empProfile" },
    { id: 3, icon: faFile, description: "My Jobs", link: "/employer/myJobs" },
    {
      id: 4,
      icon: faBullhorn,
    ...
    },
    {
      ...
      link: "/employer/jobApplicant",
    },
    {
      id: 6,
      icon: faUser,
      description: "Shortlist Candidates",
      link: "/employer/shortlistCandidate",
    },
    {
      id: 7,
      icon: faBullhorn,
