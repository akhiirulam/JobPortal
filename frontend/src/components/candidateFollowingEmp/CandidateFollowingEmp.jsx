            ...
            <div className='bg-white border p-[30px] mb-[30px] rounded '>
              ...
              <div className='w-full p-[30px] mb-[30px] h-[121px] border border-[#ECEDF2] flex rounded-md'>
                <div className='flex justify-center items-center w-full basis-2/3'>
                    <div className='w-[50px] h-[50px] rounded-full border border-black flex justify-center items-center'>Logo</div>
                    <div className='pl-5 w-full' >
                        ...
                        <div className='flex w-full font-normal leading-7 text-sm text-[#77838F]'>
                            <div className='mr-[30px] flex'>
                                <div className='mr-[5px]'><FontAwesomeIcon icon={faLocationDot} /></div>
                                <div>New York</div>
                            </div>
                            <div className='flex'>
                            <div className='mr-[5px]'><FontAwesomeIcon icon={faSuitcase} /></div>
                            <div>Advertising</div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='flex justify-end  '>
                    <div className='px-5 p-py  w-fit bg-[#E1F2E5] text-[#34A853] rounded-full'>Featured</div>
                </div>
                    
                    <div className='flex justify-end '><div className='px-5 py-0.5 w-fit bg-[#DDE8F8] hover:bg-[#1967D2] hover:text-white cursor-pointer text-[#1967D2] rounded-full'>Open Jobs - 1</div></div>
