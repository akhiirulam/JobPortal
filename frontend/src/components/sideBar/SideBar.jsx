...
import { faBullhorn, faUserTie, faLock, faUserXmark, faArrowRightFromBracket, faBars } from '@fortawesome/free-solid-svg-icons'
...
const SideBar = () => {
    ...
    return (
        <>
            <div className='block lg:hidden ml-5'><FontAwesomeIcon onClick={() => setToggleSideBar(!toggleSideBar)} icon={faBars} size="xl" /></div>
            <div className=''>
                {toggleSideBar === true ?
                    <div className='lg:hidden p-[30px] border w-[350px] h-[calc(-111px_+_100vh)] hover:overflow-y-scroll scrollbar-custom overflow-x-hidden snap-y z-10'>
                        ...
                        <div className='mt-[15px] p-[15px]'>
                            <h4 className='mb-[15px] text-lg'>Skills Percentage: <span className='font-bold leading-[1.3rem] text-[#E44343]'>100%</span></h4>
