...
const CandidateCard = ({
  ...
  <div className="flex flex-col md:flex-row items-center justify-between bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden p-4 md:h-36">
    ...
    <div className="flex items-center mb-4 md:mb-0">
      ...
      <div className="flex flex-col ml-4 md:ml-8">
        ...
        (
            ...
            <button  key={index} className="bg-gray-200 hover:bg-gray-600 hover:text-white rounded-xl w-fit px-2">{tags}
            </button>
        ))}
        </div>
      </div>
    ...
    {/* Card Content */}
    <div>
      <button className="py-2 px-4 text-white bg-blue-600 rounded-md hover:bg-blue-700 transition duration-300 text-sm md:text-base">
        {buttonText}
      </button>
    </div>
  </div>
